...
#let lectures = (
  ...
  // автоматы и порождает C, ST для ПЛК, Rust и SystemVerilog. Номер 11 стоит
  // потому, что нумерация курса ещё не утверждена, а перенумерация 09–10
  // делается вместе с общей ревизией реестра.
  (n: 11, id: "11-takt",          title: "Язык Takt: описание автоматов и порождение кода",
