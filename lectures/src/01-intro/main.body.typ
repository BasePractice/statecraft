...
#todo[
  Дописать: форма контроля, правила приёма лабораторных работ, требования к
  оформлению кода. Материал есть в `Description.md` и `practices/README.md` корня
  репозитория, его надо свести сюда.
]
