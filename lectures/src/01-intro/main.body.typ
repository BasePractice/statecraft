...
/ Теория: что такое конечный автомат, что он может и чего не может
  (лекции 2, 4, 5, 10).
/ Синтез: как получить автомат по словесному описанию задачи и как
  превратить его в схему или в код (лекции 3, 7, 8).
/ Реализация и проверка: как написанный автомат протестировать и
  верифицировать (лекции 6, 9).
