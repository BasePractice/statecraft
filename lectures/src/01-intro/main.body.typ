...
Все определения ниже используются во всех последующих лекциях; сводка
обозначений приведена в разделе «Обозначения и сокращения».
...
слов. Через $A^(oo)$ обозначается множество #emph[сверхслов] ---
...
ним стоит. Алгоритм обладает следующими свойствами:
...
Эти свойства сформулированы неформально. Их точная формализация --- и есть
машина Тьюринга, к которой курс возвращается в лекции 10, разобравшись
сначала с более простой моделью --- конечным автоматом.
