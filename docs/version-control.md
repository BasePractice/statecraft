<!-- Перенесено из каталога 02.VerControlSystem 16.08.2026: материал полезен
     курсу как справка по сдаче работ, но не относится ни к одной лекции
     по автоматам. Ссылки на картинки сделаны локальными. -->
...
![Other VCS](git_other_vcs_data.png)
...
![Git Local Operations](git_local_operations.png)
