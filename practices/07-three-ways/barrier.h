...
/*
 * Трасса выполнения: последовательность действий и состояний. Ради неё все
 * три реализации и написаны — трассы сравниваются в тестах.
 */
#define BARRIER_TRACE_MAX 64
